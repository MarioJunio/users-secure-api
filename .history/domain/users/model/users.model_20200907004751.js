...
module.exports.findByEmail = email => User.findOne({
    email: email
});

module.exports.list = (page, size) => new Promise((resolve, reject) => {
    User
        .find()
        .limit(size)
        .skip(page * size)
...
module.exports.create = (userModel) => {
    userModel.senha = PasswdUtils.cryptPasswd(userModel.senha);
...
module.exports.removeById = (userId) => new Promise((resolve, reject) => {
